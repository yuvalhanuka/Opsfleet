...
A CLI/streamlit -based data analysis assistant that answers business questions over **BigQuery’s** public dataset `bigquery-public-data.thelook_ecommerce` using an **agentic workflow**.
